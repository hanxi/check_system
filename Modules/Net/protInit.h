...
const int protGetPhotoInfo_C2S = 3;
const int protGetPhotoInfo_S2C = 4;
const int protCheckIn_C2S = 5;
const int protCheckIn_S2C = 6;
const int protSearch_C2S = 7;
const int protSearch_S2C = 8;
