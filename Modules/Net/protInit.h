...
const int protGetPhotoInfo_C2S = 5;
const int protGetPhotoInfo_S2C = 6;
const int protCheckIn_C2S = 7;
const int protCheckIn_S2C = 8;
const int protSearch_C2S = 9;
const int protSearch_S2C = 10;
